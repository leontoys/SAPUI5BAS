		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "project2",
									"targetURL": "#demosapcomproject3-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"demosapcomproject3-display": {
								"semanticObject": "demosapcomproject3",
								"action": "display",
								"description": "A master detail application.",
								"title": "project2",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=demo.sap.com.project3",
									"url": sap.ui.require.toUrl("demo/sap/com/project3")
								}
							}
						}
					}
