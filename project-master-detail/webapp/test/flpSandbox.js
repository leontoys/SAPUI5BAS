		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Master Detail",
									"targetURL": "#sapuidemofiori2projectmasterdetail-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapuidemofiori2projectmasterdetail-display": {
								"semanticObject": "sapuidemofiori2projectmasterdetail",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.ui.demo.fiori2.projectmasterdetail",
									"url": sap.ui.require.toUrl("sap/ui/demo/fiori2/projectmasterdetail")
								}
							}
						}
					}
